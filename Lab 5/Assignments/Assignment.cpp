...
void student::toString()
{
	if (name() == true)
	{
		cout << "The name of student is " << studentName;							//student name
		numberOfWordsInName();														//calling function to tell number of words in name
		cout << endl;
	}
	...
	if (roll_num() == true)
		cout << "The registration number is " << regNo << endl;						//registration number
	...
	if (cnic() == true)
	{
		cout << "The CNIC number is " << CNIC << endl;								//CNIC
		getGender();																//Calling gender
	}
	...
	if (hobby() == true)
		cout << "Hobbies are " << hobbies << endl;									//Hobbies
...
int main()
{
	...
	s1.input();													//input for default constructor

	cout << "Enter the date of birth in the format mm-dd-yyyy " << endl;
	cin >> m1 >> c1 >> d1 >> c2 >> y1;													//input for date of birth

	s1.toString();																	//printing all the attributes on console
	...
	if (c1 == '-' && c2 == '-')
	{
		...
		if (c1 == '-' && c2 == '-')
		{
			calendar.setDate(m1, d1, y1);												//condition for date of birth
	...
	cout<<endl;
	s2.toString();															//printing all the attributes on console
