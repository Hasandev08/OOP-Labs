...
int main()
{
    ...
    int input;
    cout<<"--------------------------------------------------------------------------"<<endl;
    cout<<"                    GPA & CGPA Calculator (Developed by Hasan)             "<<endl;
    cout<<"--------------------------------------------------------------------------\n"<<endl;
    cout<<"            MENU:"<<endl;
...
void calculateGPA()
{
    ...
    for(int j=0;j<q;j++)
    {
        tot=creditHours[j]*coursePoints[j];
        sum=sum+tot;
    }
    ...
    for(int k=0;k<q;k++)
    {
        creditHrs=creditHrs+creditHours[k];
    }

    cout<<"\n\n\nTotal Points: "<<sum<<" . Total Credits: "<<creditHrs<<" .Total GPA: "<<sum/creditHrs<<" ."<<endl;
